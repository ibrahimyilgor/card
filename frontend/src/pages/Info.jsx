        ...
        <Box sx={{ p: 2.5 }}>
          ...
          >
            <Box sx={{ flex: 1, minWidth: 0, pr: 2 }}>
              <Tooltip title={deck.title} arrow enterDelay={500}>
                <Typography
                  variant="h6"
                  sx={{
                    fontWeight: 600,
          ...
          {/* Description */}
          <Tooltip title={deck.description || ''} arrow enterDelay={500}>
            <Typography
              variant="body2"
              sx={{
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 2 }}>
            <Chip
              ...
              label={`${deck.flashcards?.length || 0} ${t('cards') || 'cards'}`}
              size="small"
              sx={{
                bgcolor: (theme) =>
        ...
        >
            ...
            InputProps={{
              startAdornment: (
                <InputAdornment position="start">
                  <SearchIcon sx={{ color: 'text.cardSubtitle', fontSize: 20 }} />
                </InputAdornment>
              ),
            }}
          ...
          <FormControl size="small" sx={{ minWidth: 140 }}>
            <Select
              ...
              displayEmpty
              startAdornment={
                <SortIcon sx={{ color: 'text.cardSubtitle', mr: 1, fontSize: 18 }} />
              }
              sx={{
                borderRadius: '12px',
                fontFamily: 'Inter, sans-serif',
            ...
            >
              ...
              <MenuItem value="cards">{t('sort_cards') || 'Most Cards'}</MenuItem>
            </Select>
          </FormControl>
