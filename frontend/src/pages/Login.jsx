  ...
  const features = [
    {
      ...
      description: t('adaptable_performance_desc') || 'Adaptive flashcard system that learns your pace and optimizes your study sessions.',
    },
    {
      icon: BuildIcon,
      title: t('built_to_last') || 'Track Progress',
      description: t('built_to_last_desc') || 'Detailed statistics and insights to help you understand your learning patterns.',
    },
    {
      icon: ThumbUpAltIcon,
      title: t('great_account_experience') || 'Easy to Use',
      description: t('great_account_experience_desc') || 'Clean, intuitive interface designed for focused learning without distractions.',
    },
    {
      icon: AutoAwesomeIcon,
      title: t('innovative_functionality') || 'Beautiful Design',
      description: t('innovative_functionality_desc') || 'Modern, elegant design with dark and light themes for comfortable studying.',
    },
  ];
