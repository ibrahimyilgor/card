      ...
      <Box sx={{ display: 'flex', width: '100%', maxWidth: 1200, mx: 'auto', boxSizing: 'border-box', height: { xs: 'auto', md: 600 }, boxShadow: 0 }}>
        ...
        <Box sx={{ padding: 5, flex: 1, display: { xs: 'none', sm: 'none', md: 'flex' }, flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-end', pr: 8, bgcolor: 'transparent' }}>
          <Box>
            ...
            <Box sx={{ mb: 2, display: 'flex', alignItems: 'center' }}>
              ...
              <Box>
                <Typography variant="subtitle1" sx={{ fontWeight: 600 }} color="text.primary">{t('adaptable_performance') || 'Adaptable performance'}</Typography>
                <Typography variant="body2" color="text.gray">{t('adaptable_performance_desc') || 'Our product effortlessly adjusts to your needs, boosting efficiency and simplifying your tasks.'}</Typography>
              </Box>
            </Box>
            <Box sx={{ mb: 2, display: 'flex', alignItems: 'center' }}>
              <BuildIcon color="primary" sx={{ mr: 2 }} />
              <Box>
                <Typography variant="subtitle1" sx={{ fontWeight: 600 }} color="text.primary">{t('built_to_last') || 'Built to last'}</Typography>
                <Typography variant="body2" color="text.gray">{t('built_to_last_desc') || 'Experience unmatched durability that goes above and beyond with lasting investment.'}</Typography>
              </Box>
            </Box>
            <Box sx={{ mb: 2, display: 'flex', alignItems: 'center' }}>
            ...
            <Box sx={{ mb: 2, display: 'flex', alignItems: 'center' }}>
              ...
              <Box>
                <Typography variant="subtitle1" sx={{ fontWeight: 600 }} color="text.primary">{t('innovative_functionality') || 'Innovative functionality'}</Typography>
                <Typography variant="body2" color="text.gray">{t('innovative_functionality_desc') || 'Stay ahead with features that set new standards, addressing your evolving needs better than the rest.'}</Typography>
              </Box>
            </Box>
          </Box>
        </Box>
        ...
        <Box sx={{ padding: 5, flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', bgcolor: 'transparent' }}>
          <Paper elevation={3} sx={{ width: '100%', maxWidth: 400, p: { xs: 2, sm: 4 }, borderRadius: 3, borderColor: 'border.main', borderStyle: 'solid', borderWidth: 0.5, bgcolor: 'background.default', boxShadow: '0 4px 4px 0 rgba(0,0,0,0.25)' }}>
            <Typography variant="h5" sx={{ fontWeight: 700, mb: 3 }} color="text.primary">{t('login')}</Typography>
            <Box component="form" onSubmit={handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              ...
              <Button type="submit" variant="contained" color="primary" fullWidth sx={{ fontWeight: 600, fontSize: 16, py: 1.2, textTransform: 'none' }}>{t('login')}</Button>
            </Box>
