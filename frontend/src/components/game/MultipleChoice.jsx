            ...
            >
              ...
              <Box
                sx={{
                  ...
                  flexShrink: 0,
                  background: showResult && option.isCorrect
                    ...
                    : showResult && isSelected && !option.isCorrect
                      ...
                      : isSelected
                        ...
                        : isDark
                          ...
                          : 'rgba(0, 0, 0, 0.08)',
                  color: (showResult && (option.isCorrect || (isSelected && !option.isCorrect))) || isSelected
                    ? '#ffffff'
              ...
              {/* Result icon */}
              {showResult && (option.isCorrect || (isSelected && !option.isCorrect)) && (
                <Box sx={{ flexShrink: 0 }}>
                  {option.isCorrect ? (
