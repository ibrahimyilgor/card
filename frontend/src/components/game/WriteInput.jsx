...
export default function WriteInput({ 
  ...
  const getHint = () => {
    ...
    if (words.length > 1) {
      return words.map(word => word.charAt(0) + '_'.repeat(word.length - 1)).join(' ');
    }
    return correctAnswer.charAt(0) + '_'.repeat(Math.max(0, correctAnswer.length - 1));
  };
          ...
          {!showResult && (
            <Box sx={{ display: 'flex', gap: 2, justifyContent: 'center' }}>
              <StyledButton
                ...
                size="small"
              >
                {showHint ? (t('hide_hint') || 'Hide Hint') : (t('show_hint') || 'Show Hint')}
              </StyledButton>
              ...
              <MotionBox
                ...
                sx={{
                  ...
                  background: isCorrect 
                    ? alpha('#22c55e', 0.1)
                    : alpha('#ef4444', 0.1),
                  border: `1px solid ${isCorrect ? alpha('#22c55e', 0.3) : alpha('#ef4444', 0.3)}`,
                  textAlign: 'center',
                }}
              >
                ...
                {!isCorrect && (
                  ...
                  >
                    ...
                    <Box component="span" sx={{ color: 'text.cardTitle', fontWeight: 600 }}>
                      {correctAnswer}
                    </Box>
                  </Typography>
                )}
